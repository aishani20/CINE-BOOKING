...
void MyDB::init()
{
    ...
    db.setDatabaseName("C:/Users/user/Downloads/QT_Project_On_Movie_Ticket_Booking/cppbuzz_movie_ticket_booking.sqlite");

    //if(QFile::exists("c:/cppbuzz_movie_ticket_booking.sqlite"))
    if(QFile::exists("C:/Users/user/Downloads/QT_Project_On_Movie_Ticket_Booking/cppbuzz_movie_ticket_booking.sqlite"))
